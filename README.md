...
or is from a view that does something similar. This datatype is NOT a scalar date and that throws
the PTF engine into a tizzy. You must cast the value to DATE if you want to use it in a PTF:

    CAST(TO_DATE('01/01/2021','MM/DD/YYYY') AS DATE) AS mycol
    or
    CAST(SYSDATE AS DATE) AS mycol
...
report it in a little more helpful way, but if you are opening your own cursor, you will get ORA62668,
and the explanation is less than helpful. This [post](https://blog.sqlora.com/en/using-subqueries-with-ptf-or-sql-macros/)
is where I found out about it.
